...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/toimage)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/toimage
```

A live public deployment of this template is available at [https://toimage.templates.workers.dev](https://toimage.templates.workers.dev)
